# Video walkthrough — narration script (target discovery)

**Chengchen (Sam) Duan** — research-track solo submission.

**The submission video is complete and narrated:** `deliverables/brakepoint_video.mp4`
...
(`deliverables/brakepoint_video.vtt`) are per-sentence and on-brand styled in the landing
