...
The finding is a **computational re-analysis of the public Marson lab (Gladstone) + Pritchard lab (Stanford) genome-scale CD4⁺ T-cell CRISPRi screen** (bioRxiv 10.64898/2025.12.23.696273); every evidence layer below is public and OSS-licensed. All sources are snapshotted with the dates below; no non-OSS / non-commercial data is bundled into the repo.

## Datasets
| Dataset | Use | Accession | License | Snapshot date |
|---|---|---|---|---|
| **Gladstone genome-scale CD4⁺ T-cell CRISPRi Perturb-seq** (Marson lab, Gladstone, with the Pritchard lab, Stanford) | **primary (the finding)** | CZI Virtual Cells Platform `genome-scale-tcell-perturb-seq`; build `GWCD4i_Stim8hr_D1D2.built.h5ad` (donors D1+D2, Stim 8 h); bioRxiv 10.64898/2025.12.23.696273 | MIT (data-sharing) | 2026-07-10 |
