...
3. **Druggability** — the most tractable novel nomination: **10 drugs** including approved agents **basiliximab** and **daclizumab** (anti-IL-2R antibodies), **aldesleukin / nogapendekin** (IL-2 agonists), plus Phase 1–3 candidates. Both antibody and small-molecule-structure tractability.
4. **Human genetics / regulatory support** — Open Targets **genetic_association = 0.77** for immunodeficiency-with-autoimmunity, plus associations with **multiple sclerosis** (0.53), **type-1 diabetes**, and immune-system disorders — direct autoimmune relevance.
